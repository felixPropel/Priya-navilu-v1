    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Edit New User</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="/">User</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
        ...
        @endforeach
                    ...
                    <div class="card-body " id="bar-parent">
                        <form id="form" action="{{route('updateUser',['id'=>$id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="role" class="form-control" required>
                                            ...
                                            <option <?php if($role->id==$default->role_id){ echo "selected";}?> value="{{$role->id}}">{{$role->role_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Enter Name" value="{{$default->name}}"/>
                                    </div>
                                </div>
