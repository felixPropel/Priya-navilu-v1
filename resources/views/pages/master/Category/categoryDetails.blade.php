    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title"><?php echo (isset($model)) ? "Edit Category" : "Add Category" ?></div>
                </div>
            ...
            <div class="col-md-12 col-sm-6">
                <div class="card card-box">
                    ...
                    <div class="card-body " id="bar-parent">
                        ...
                        <form action="{{url('categoryMaster')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control" name="name" id="tag" placeholder="Enter category Name" value="<?php echo (isset($model)) ? $model->name : "" ?>" />
