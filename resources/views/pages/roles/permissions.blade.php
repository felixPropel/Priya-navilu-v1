...
<div class="page-content-wrapper">
    <div class="page-content">
      <a href="{{route('addPermission')}}"><button type="button" class="btn btn-xs btn-success">+ ADD</button></a>
        <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <table id="example1" class="display" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$p->name}}</td>
                                                <td >
                                                <a href="{{route('editPermission',['id'=>$p->id])}}"><button class="btn btn-xs deepPink-bgcolor dropdown-toggle no-margin" type="button"><i class="fa fa-pencil"></i> Edit</button></a>
