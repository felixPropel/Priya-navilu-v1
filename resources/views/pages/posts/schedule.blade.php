...
<div class="page-content-wrapper">
    <div class="page-content">
        <div class="page-bar m-0 ">
            <div class="page-title-breadcrumb m-0">
                <div class=" pull-left">
                        ...
                        <table id="example1" class="display" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$p['tag_name']}}</td>
                                    <td>{{$p['schedule_date']}}</td>
                                    <td>
                                        <a href="{{route('editSchedulePost',['id'=>$p['post_id']])}}"><button class="btn btn-xs deepPink-bgcolor dropdown-toggle no-margin" type="button"><i class="fa fa-pencil"></i> Edit</button></a>
