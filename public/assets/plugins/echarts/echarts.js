...
! function(e) {
    ...
    return i.prototype = {
        _init: function() {
            ...
            var u = e("./component");
            u.define("title", e("./component/title")), u.define("tooltip", e("./component/tooltip")), u.define("legend", e("./component/legend")), (0 === i.getWidth() || 0 === i.getHeight()) && console.error("Domâ€™s width & height should be ready before init.")
        },
    ...
    return t.prototype = {
        ...
        __onSaveAsImage: function() {
            ...
            a.href = i, a.setAttribute("download", (e.name ? e.name : this.option.title && (this.option.title.text || this.option.title.subtext) ? this.option.title.text || this.option.title.subtext : "ECharts") + "." + t), a.innerHTML = '<img style="vertical-align:middle" src="' + i + '" title="' + (window.ActiveXObject || "ActiveXObject" in window ? "å³é”®->å›¾ç‰‡å¦å­˜ä¸º" : e.lang ? e.lang[0] : "ç‚¹å‡»ä¿å­˜") + '"/>', n.appendChild(a), document.body.appendChild(n), a = null, n = null, setTimeout(function() {
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : ! function() {
        ...
        function b(e) {
            this.m_ = s(), this.mStack_ = [], this.aStack_ = [], this.currentPath_ = [], this.strokeStyle = "#000", this.fillStyle = "#000", this.lineWidth = 1, this.lineJoin = "miter", this.lineCap = "butt", this.miterLimit = 1 * F, this.globalAlpha = 1, this.font = "12px å¾®è½¯é›…é»‘", this.textAlign = "left", this.textBaseline = "alphabetic", this.canvas = e;
        ...
        brush: function(e, i) {
            ...
            if (i && (n = this.getHighlightStyle(n, this.highlightStyle || {})), "undefined" != typeof n.text && n.text !== !1) {
                ...
                var a, o = (n.text + "").split("\n"),
                    r = t.getTextHeight("å›½", n.textFont),
                    s = this.getRect(n),
                    l = n.x;
    ...
    function k(e, t) {
        ...
        if (X[i]) return X[i];
        v = v || L.getContext(), v.save(), t && (v.font = t), e = (e + "").split("\n");
        var n = (v.measureText("å›½").width + 2) * e.length;
    ...
    function t(t, n, a, o, r, s, l) {
        ...
        var h = i(n, a, o, r, s, l);
        n = (n + "").split("\n");
        var d = e("../tool/area").getTextHeight("å›½", r);
        switch (l) {
            case "top":
                o = h.y;
                break;
