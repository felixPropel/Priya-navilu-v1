/*! Image Uploader - v1.2.3 - 26/11/2019image
...
!(function (e) {
  e.fn.imageUploader = function (t) {
    ...
    let o = function () {
        ...
        e("<i>", { class: "fa fa-cloud-upload" }).appendTo(i),
      ...
      l = function (t, i, o) {
        let l = e("<div>", { class: "uploaded-image" }),
          r =
            ...
            e("<button >", { class: "delete-image btn btn-danger" }).appendTo(l));
        e("<i>", { class: "fa fa-trash-o" }).appendTo(r);
        if (o) {
